...
import simpledb.tx.recovery.QuiescentCP;
...
public class Transaction {
   ...
   public static List<Transaction> activeTx = new ArrayList<Transaction>();
   private static List<Transaction> waitList = new ArrayList<Transaction>();
   public static boolean ongoingCP = false;
  public QuiescentCP checkpoint;
   ...
   public Transaction() {
      ...
      while (ongoingCP){
          try {
               synchronized (Transaction.lock){lock.wait();}
